        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TankLiters = table.Column<int>(type: "int", nullable: false),
                    DriversAvailable = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemberTrip", x => new { x.MembersId, x.TripsId });
                    table.ForeignKey(
                        name: "FK_MemberTrip_Members_MembersId",
                        column: x => x.MembersId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MemberTrip_Trips_TripsId",
                        column: x => x.TripsId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BorderDistance = table.Column<int>(type: "int", nullable: true),
                    SleepoverCost = table.Column<double>(type: "float", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Routes_Countries_CountryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MemberTrip_TripsId",
                table: "MemberTrip",
                column: "TripsId");

            migrationBuilder.CreateIndex(
                name: "IX_Routes_CountryId",
                table: "Routes",
                column: "CountryId");
